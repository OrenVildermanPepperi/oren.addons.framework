...
var entities_1 = entities.Entities;
...
class AddonApiEndpoint {
    ...
    GetAddonApiUrl(params = {}) {
        ...
        var queryString = endpoint_1.default.encodeQueryParams(params);
...
var addons_1 = addons$1.AddonEndpoint;
...
var codeJobs_1 = codeJobs$1.CodeJobsEndpoint;

var metaData = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.DistributorFlagsEndpoint = void 0;
...
var metaData_1 = metaData.DistributorFlagsEndpoint;
...
class PapiClient {
    constructor(options) {
        ...
        this.fileStorage = new endpoint_1.default(this, '/file_storage');
    }
    async get(url) {
    ...
    async apiCall(method, url, body = undefined) {
        ...
        const res = await node_fetch_1.default(fullURL, options);
...
var papiClient_1 = papiClient.PapiClient;
...
async function js_foo$1(client, request) {
    return api2.js_foo(client, request);
}

exports.foo = foo;
exports.js_foo = js_foo$1;
